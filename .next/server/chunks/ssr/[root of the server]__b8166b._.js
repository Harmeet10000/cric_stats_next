...
const AuthProvider = ({ children })=>{
    ...
    const handleLogin = async (email, password)=>{
        ...
        if (email === "admin@example.com" && password === "adminpass") {
        ...
        } else if (email === "audience@example.com" && password === "audiencepass") {
            const audienceUser = {
                id: "2",
                email: email,
                role: "audience"
            ...
            localStorage.setItem("user", JSON.stringify(audienceUser));
...
"[project]/src/components/ui/dropdown-menu.tsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require } = __turbopack_context__;
{
const e = new Error("Could not parse module '[project]/src/components/ui/dropdown-menu.tsx'");
e.code = 'MODULE_UNPARSEABLE';
throw e;}}),
"[project]/src/components/layout/Navbar.tsx [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b8166b._.js.map